...
async function signIn() {
  ...
  const params = new URLSearchParams({
    ...
    redirect_uri: 'https://project.dhilip.in/',
    scope: 'openid profile email',
    state,
...
AUDIENCE = "client_5XUv807ZGIcV5LG0R-CE6w"
...
```json
{
  "iss": "http://localhost:8000",
  "sub": "user-uuid",
  "aud": "client_5XUv807ZGIcV5LG0R-CE6w",
  "iat": 1700000000,
  "exp": 1700003600,
  "email": "user@example.com",
  "email_verified": true,
...
- **Backend API docs** → `http://localhost:8000/docs` (when DEBUG=true)
